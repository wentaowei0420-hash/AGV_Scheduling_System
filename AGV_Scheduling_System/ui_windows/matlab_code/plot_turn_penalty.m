...
function turnPenalty = compute_turn_penalty(payload_weight, base_penalty, linear_factor, inertia_factor)
    ...
    %   base_penalty   - （可选）基础转弯惩罚，默认 1
    %   linear_factor  - （可选）线性负载因子，模拟摩擦力增加，默认 0.00001
    %   inertia_factor - （可选）二阶惯性因子，模拟重载离心惯量，默认 3/6400
    %
    % 输出:
